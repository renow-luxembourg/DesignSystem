  ...
  <div class="form-group">
    ...
    <div class="form-group-field">
      ...
      <div class="alert alert--info"> 
        <p id="iban-desc">Numéro entre 14 et 34 position (Numéro de compte renseigné sur le relevé d'identité bancaire tel que : LU00 0000 0000 0000 0000)</p>
      </div>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="form-group-field">
      ...
      <div class="alert alert--info"> 
        <p id="bic-desc">Numéro à 8 ou 11 positions (code BIC renseigné sur le relevé d'identité bancaire)
        </p>
      </div>
    </div>
  </div>
